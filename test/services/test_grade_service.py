...
class TestGradeService(unittest.TestCase):
    ...
    def test_get_grades_success(self, mock_get_instance):
        ...
        # Act
        grades = service.get_grades(self.mock_token, self.mock_breadcrumb)
    ...
    @patch('src.services.grade_service.MongoIO.get_instance')
    def test_get_grades_no_permission(self, mock_get_instance):
        """Test get_grades raises HTTPForbidden when user has no roles."""
        # Arrange
        mock_token_no_roles = {"user_id": "test_user", "roles": []}
        
        # Act & Assert
        service = GradeService()
        with self.assertRaises(HTTPForbidden):
            service.get_grades(mock_token_no_roles, self.mock_breadcrumb)
    ...
    def test_get_grade_success(self, mock_get_instance):
        ...
        # Act
        grade = service.get_grade("123", self.mock_token, self.mock_breadcrumb)
    ...
    def test_get_grade_not_found(self, mock_get_instance):
        """Test get_grade returns None when grade not found."""
        # Arrange
        mock_mongo = MagicMock()
        ...
        # Act
        grade = service.get_grade("999", self.mock_token, self.mock_breadcrumb)
    ...
    def test_get_grade_exception(self, mock_get_instance):
        ...
        with self.assertRaises(HTTPInternalServerError):
            service.get_grade("123", self.mock_token, self.mock_breadcrumb)
