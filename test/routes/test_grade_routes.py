...
class TestGradeRoutes(unittest.TestCase):
    ...
    def test_get_grades_success(self, mock_get_grades, mock_create_breadcrumb, mock_create_token):
        ...
        mock_get_grades.return_value = [{"_id": "123", "name": "Grade A"}]
        ...
        mock_get_grades.assert_called_once_with(mock_token, mock_breadcrumb)
    
    @patch('src.routes.grade_routes.create_flask_token')
    @patch('src.routes.grade_routes.create_flask_breadcrumb')
    @patch('src.routes.grade_routes.GradeService.get_grade')
    def test_get_grade_success(self, mock_get_grade, mock_create_breadcrumb, mock_create_token):
        ...
        mock_get_grade.return_value = {"_id": "123", "name": "Grade A"}
        ...
        mock_get_grade.assert_called_once_with("123", mock_token, mock_breadcrumb)
    
    @patch('src.routes.grade_routes.create_flask_token')
    @patch('src.routes.grade_routes.create_flask_breadcrumb')
    @patch('src.routes.grade_routes.GradeService.get_grade')
    def test_get_grade_not_found(self, mock_get_grade, mock_create_breadcrumb, mock_create_token):
        ...
        mock_get_grade.side_effect = HTTPNotFound("Grade 999 not found")
